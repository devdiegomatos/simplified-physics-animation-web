...
Porém, a origem sempre estará contida na região de Voronoi do segmento, pois, por construção os pontos de suporte A e B estão no limite do CSO. Logo, se a origem estivesse na região de A ou B isso seria um contradição, pois isso significaria que A ou B estão mais próximos da origem do que o segmento $\overline{AB}$, o que não é possível. Dessa forma, a próxima direção de busca apontando para origem é perpendicular ao segmento $\overline{AB}$.
