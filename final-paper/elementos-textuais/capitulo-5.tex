...
Em ambientes dinâmicos, nos quais objetos se movem continuamente e podem ser criados ou removidos, a manutenção incremental da estrutura espacial torna-se um aspecto crítico. Embora seja possível atualizar apenas os elementos afetados por cada objeto em movimento, essa abordagem exige controle adicional e estruturas auxiliares. Neste trabalho, opta-se deliberadamente por uma estratégia mais simples: a estrutura é reconstruída a cada passo de tempo a partir de um array linear, cujo conteúdo é esvaziado (por exemplo, via ajuste de seu tamanho lógico) e preenchido novamente com base na ordenação das chaves de célula. Essa decisão representa um trade-off arquitetural, privilegiando simplicidade e previsibilidade de execução em detrimento de possíveis otimizações incrementais.
